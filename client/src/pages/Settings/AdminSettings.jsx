        ...
        <div className=" flex gap-4 md:gap-14 h-[90%] flex-wrap ">
          ...
          <div className="w-[100%] md:w-1/2 mt-4">
            ...
            >
              {/* USER ID */}
              <div>
                <Label className="text-md">Admin Id</Label>
                <Input
                  type="text"
                  value={admin._id}
                  disabled
              ...
              {/* Id PROOF */}
              <div>
                <Label className="text-md">Id Proof</Label>
                <Input
                  type="text"
                  id="idProof"
                  value={admin?.idProof}
              ...
              <Button disabled={isUpdating || isPending}>Update Profile</Button>
            </form>
          </div>
        </div>
      </div>
